...
export interface News { slug: string; title: string; source: string; sourceUrl: string; publishedAt: string; companies: string[]; category: string; market?: 'global'|'mainland'; summary: string; importance: number; }
